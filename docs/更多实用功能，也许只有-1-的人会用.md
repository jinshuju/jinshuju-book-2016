...
表单，最重要的功能就是帮助人们快速收集、整理各种信息，不过这些信息大多数时候都是文本信息。你有没有想过如何收集或整理图片、word 文档、PSD 设计图这样的文件？

我们的「上传文件」字段就是用来收集一切文件的，且提供了文档、图片、视频、音频、压缩包五种常用的格式类型，如果你需要特殊的格式限制，我们也提供了完全自定义的格式限制，只需填入需要的格式后缀名即可。



![](https://dn-shimo-image.qbox.me/8J5Ol8i1QSEX2TTu/image.png!thumbnail)
